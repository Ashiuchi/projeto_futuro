...
```mermaid
gantt
    title Planejamento de Hoje (3h Líquidas + Discursiva)
    dateFormat  HH:mm
    axisFormat %H:%M
    section Bloco 1 (1h30)
    Língua Portuguesa (Sintaxe & Conectivos) : active, b1, 19:30, 21:00
    section Bloco 2 (1h30)
    ANPD & Legislação (ECA Digital Lei 15211 + Upload PDFs) : active, b2, 21:15, 22:45
    section Prática (30m)
    App Web (Bateria Cebraspe + Treino Discursiva) : active, b3, 22:45, 23:15
```
